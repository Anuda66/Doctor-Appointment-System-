...
function Header() {
  return (
    <div className="flex flex-col flex-wrap px-6 bg-green-500 rounded-3xl md:flex-row md:px-10 lg:px-20 ">
      {/*left side------------------------------------------------------------------ */}
      <div className="flex flex-col items-start justify-center gap-4 py-10 m-auto md:w-1/2 md:py-[10vw] md:mb-[-30px] ">
        ...
        <div className="flex">
          <a
            ...
            href="#speciality"
          >
            Book Appointment <FaLongArrowAltRight className="text-gray-600" />
          </a>
        </div>
      </div>
      {/*right side------------------------------------------------------------------ */}
