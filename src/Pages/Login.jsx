  ...
  return (
    <form className="min-h-[80vh] flex items-center ">
      <div className="flex flex-col items-start gap-3 p-8 m-auto min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg">
        ...
        <button className="w-full pt-2 pb-2 text-base text-white transition duration-300 ease-in-out delay-150 bg-green-400 rounded-2xl bg-primary hover:bg-green-500 hover:shadow-lg hover:-translate-y-1 hover:scale-110">
          {state === "Sing Up" ? "Create Account" : "Login"}
        </button>
        {state === "Sing Up" ? (
          <p>
